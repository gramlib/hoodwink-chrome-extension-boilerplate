...
import { codiconStartMarker } from '@hoodwink/common/base/codicon';
...
export class Codicon {
  constructor(
    ...
    public readonly definition: Codicon | IconDefinition,
  ...
  public get classNamesArray() {
    return ['codicon', `codicon-${this.id}`];
  }

  public get cssSelector() {
    return `.codicon.codicon-${this.id}`;
  }
}
...
export namespace Codicon {
  ...
  export const gitPullRequestAbandoned = new Codicon('git-pull-request-abandoned', {
    character: '\\ea64',
  });
  ...
  export const debugBreakpointDisabled = new Codicon('debug-breakpoint-disabled', {
    character: '\\ea71',
  });
  ...
  export const debugBreakpointConditionalUnverified = new Codicon(
    'debug-breakpoint-conditional-unverified',
    { character: '\\eaa6' },
  );
  export const debugBreakpointConditional = new Codicon('debug-breakpoint-conditional', {
    character: '\\eaa7',
  });
  export const debugBreakpointConditionalDisabled = new Codicon(
    'debug-breakpoint-conditional-disabled',
    { character: '\\eaa7' },
  );
  export const debugBreakpointDataUnverified = new Codicon('debug-breakpoint-data-unverified', {
    character: '\\eaa8',
  });
  export const debugBreakpointData = new Codicon('debug-breakpoint-data', { character: '\\eaa9' });
  export const debugBreakpointDataDisabled = new Codicon('debug-breakpoint-data-disabled', {
    character: '\\eaa9',
  });
  export const debugBreakpointLogUnverified = new Codicon('debug-breakpoint-log-unverified', {
    character: '\\eaaa',
  });
  export const debugBreakpointLog = new Codicon('debug-breakpoint-log', { character: '\\eaab' });
  export const debugBreakpointLogDisabled = new Codicon('debug-breakpoint-log-disabled', {
    character: '\\eaab',
  });
  ...
  export const debugBreakpointUnverified = new Codicon('debug-breakpoint-unverified', {
    character: '\\eabc',
  });
  ...
  export const fileSymlinkDirectory = new Codicon('file-symlink-directory', {
    character: '\\eaed',
  });
  ...
  export const debugBreakpointFunctionUnverified = new Codicon(
    'debug-breakpoint-function-unverified',
    { character: '\\eb87' },
  );
  export const debugBreakpointFunction = new Codicon('debug-breakpoint-function', {
    character: '\\eb88',
  });
  export const debugBreakpointFunctionDisabled = new Codicon('debug-breakpoint-function-disabled', {
    character: '\\eb88',
  });
  export const debugStackframeActive = new Codicon('debug-stackframe-active', {
    character: '\\eb89',
  });
  ...
  export const debugStackframeFocused = new Codicon('debug-stackframe-focused', {
    character: '\\eb8b',
  });
  export const debugBreakpointUnsupported = new Codicon('debug-breakpoint-unsupported', {
    character: '\\eb8c',
  });
  export const symbolString = new Codicon('symbol-string', { character: '\\eb8d' });
  export const debugReverseContinue = new Codicon('debug-reverse-continue', {
    character: '\\eb8e',
  });
...
export function markdownUnescapeCodicons(text: string): string {
  return text.replace(markdownUnescapeCodiconsRegex, (match, escaped, codicon) =>
    escaped ? match : `$(${codicon})`,
  );
}
...
export function stripCodicons(text: string): string {
  ...
  return text.replace(stripCodiconsRegex, (match, preWhitespace, escaped, postWhitespace) =>
