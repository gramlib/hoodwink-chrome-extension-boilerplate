...
import { onUnexpectedError } from '@hoodwink/common/base/errors';
import { once as onceFn } from '@hoodwink/common/base/functional';
import {
  Disposable,
  IDisposable,
  toDisposable,
  combinedDisposable,
  DisposableStore,
} from '@hoodwink/common/base/lifecycle';
import { LinkedList } from '@hoodwink/common/base/linkedList';
...
export class AsyncEmitter<T extends IWaitUntil> extends Emitter<T> {
  ...
  async fireAsync(
    ...
    while (this._asyncDeliveryQueue.size > 0 && !token.isCancellationRequested) {
      ...
      const thenables: Array<Promise<any>> = [];
...
export class EventMultiplexer<T> implements IDisposable {
  ...
  private events: Array<{ event: Event<T>; listener: IDisposable | null }> = [];
