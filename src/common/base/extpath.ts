...
import { startsWithIgnoreCase, equalsIgnoreCase, rtrim } from '@hoodwink/common/base/strings';
import { CharCode } from '@hoodwink/common/base/charCode';
import { sep, posix, isAbsolute, join, normalize } from '@hoodwink/common/base/path';
import { isNumber } from '@hoodwink/common/base/types';
