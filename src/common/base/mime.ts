...
import { basename, posix, extname } from '@hoodwink/common/base/path';
import { startsWithUTF8BOM } from '@hoodwink/common/base/strings';
import { match } from '@hoodwink/common/base/glob';
import { URI } from '@hoodwink/common/base/uri';
import { Schemas } from '@hoodwink/common/base/network';
import { DataUri } from '@hoodwink/common/base/resources';
