...
import { illegalState } from '@hoodwink/common/base/errors';
import { Graph } from '@hoodwink/common/instantiation/graph';
...
class Trace {
  ...
  private readonly _dep: Array<[ServiceIdentifier<any>, boolean, Trace?]> = [];
