...
import {
  ...
  optional,
  ServicesAccessor,
} from '@hoodwink/common/instantiation/instantiation';
...
const IService1 = createServiceDecorator<IService1>('service1');
...
const IService2 = createServiceDecorator<IService2>('service2');
...
const IService3 = createServiceDecorator<IService3>('service3');
...
const IDependentService = createServiceDecorator<IDependentService>('dependentService');
...
describe('Instantiation Service', () => {
  ...
  test('Remote window / integration tests is broken #105562', function () {
    const Service1 = createServiceDecorator<any>('service1');
    class Service1Impl {
    ...
    const Service2 = createServiceDecorator<any>('service2');
    class Service2Impl {
      constructor() {}
    }
    ...
    const Service21 = createServiceDecorator<any>('service21');
    class Service21Impl {
      constructor(
